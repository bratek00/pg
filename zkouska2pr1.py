def find_divisible(max_number, divisor):
    # Vytvoříme prázdný seznam, kam budeme ukládat výsledky
    divisible_numbers = []
    
    # Použijeme cyklus, abychom prošli všechna čísla od 1 do max_number
    for number in range(1, max_number + 1):
        # Zkontrolujeme, zda je číslo dělitelné beze zbytku
        if number % divisor == 0:
            # Pokud ano, přidáme ho do seznamu
            divisible_numbers.append(number)
    
    # Vrátíme seznam čísel
